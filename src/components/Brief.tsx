...
const Brief: React.FC = () => {
  ...
  const dialogues = [
    { buttonText: ["", "Next", ""], 
    labelText: "It's a beautiful day at the forest, where Detective Bingus is camping"},
    ...
    { buttonText: ["1", "JACK?!", "1?"], labelText: "Detective Gerbils: The murderer.....is Jack" },
    { buttonText: ["", "", "1?"], labelText: "Detective Gerbils: Thats It, I have cracked the case." },
